export const validate = ({ userID, nickname, password, passwordRepeat }) => {
    ...
    */
    ...
    if (userID.length === 0) {
      ...
      errors.userID = "아이디는 6-12자의 영문, 숫자만 사용 가능합니다.";
    }
    ...
    */
    ...
    if (nickname.length === 0)  {
      ...
      errors.nickname = "닉네임은 2-20자의 영문, 숫자, 기호만 사용 가능하며, 꼭 한글이나 영문을 포함하고 있어야 합니다.";
    }
    ...
    */
    ...
    if (password.length === 0 || passwordRepeat.length === 0)  {
      ...
      errors.password = '입력하신 두 비밀번호가 다릅니다.';
    } else if (!passwrodRegex.test(password)) {
      errors.password= "비밀번호는 8-20자의 영문, 숫자, 기호만 사용 가능하며, 두 종류 이상을 조합해야 합니다.";
    }
